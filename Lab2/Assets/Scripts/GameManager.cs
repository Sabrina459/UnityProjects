...
//	[Tooltip("If not set, the player will default to the gameObject tagged as Player.")]
	...
	public Text gameVictoryScoreDisplay;
	public GameObject endHameSource;
		...
		switch (gameState)
		{
			case gameStates.Playing:
				if (playerHealth.isAlive == false)
				{
					...
					// set the end game score
					gameVictoryScoreDisplay.text = mainScoreDisplay.text;
			...
			case gameStates.Death:
				...
				if (backgroundMusic.volume<=0.0f) {
					AudioSource.PlayClipAtPoint(gameOverSFX,endHameSource.transform.position);
